...
// to run test: sail artisan test --filter LibPlanLanguageSpanishTest
class LibPlanLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/subscription-plan/src/resources/lang';
